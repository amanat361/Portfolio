...
$$
E[k] = \frac{1}{p} + \left(\frac{1}{p}\right)^2 + \left(\frac{1}{p}\right)^3 + \cdots + \left(\frac{1}{p}\right)^k
$$

For 10 consecutive heads at 20%, you're looking at $\frac{1}{p} = 5$, which means $E[10] = 5 + 25 + 125 + \cdots + 5^{10} \approx$ **12.2 million flips**. At 50%, it's $\frac{1}{p} = 2$, so $E[10] = 2 + 4 + 8 + \cdots + 1024 \approx$ **2,046 flips**. Every percentage point matters because you're raising numbers to the 10th power. Small changes compound into massive differences that will make you question your life choices.
