  ...
  return (
    <div className="not-prose my-8 grid gap-6 sm:grid-cols-2">
      <div className="rounded-lg border border-red-500/20 bg-red-500/5 p-6">
        <h3 className="mb-4 text-sm font-semibold uppercase tracking-wide text-red-600 dark:text-red-400">
          Issues
        </h3>
        <ul className="space-y-2 text-sm text-zinc-600 dark:text-zinc-400">
          <li>WiFi disconnects when keyboard detaches</li>
          <li>WiFi disconnects when keyboard reattaches</li>
          <li>Second screen unusable (covered by keyboard)</li>
          <li>Touchscreen input goes to wrong display</li>
          <li>Media keys don't work (Fn key broken)</li>
          <li>Manual intervention required each time</li>
        </ul>
      </div>
      <div className="rounded-lg border border-green-500/20 bg-green-500/5 p-6">
        ...
        <ul className="space-y-2 text-sm text-zinc-600 dark:text-zinc-400">
          <li>WiFi persists automatically during all keyboard events</li>
          <li>Second screen auto-enables when keyboard detaches</li>
          <li>Second screen auto-disables when keyboard attaches</li>
          <li>Touchscreens correctly mapped to their displays</li>
          <li>Stacked monitor layout (top/bottom) configured</li>
          <li>Media keys remapped to Super+F-keys with OSD</li>
          <li>Desktop notifications for all events</li>
          <li>Zero overhead (event-driven, no background processes)</li>
        </ul>
      </div>
    </div>
  )
